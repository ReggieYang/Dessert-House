...
<jsp:useBean id="cart" class="beans.SaleRecord_view" scope="page"></jsp:useBean>
...
<%--                     <button id="btn<%=i%>" cid=<jsp:getProperty name="com" property="commodity_id" /> 
                     ...
                     <a class="btn-danger col-sm-3 btn-sm sendmessage" href="user/delcom?cid=<%=com.getCommodity_id() %>">删除</a>
                  </div>
					</TD>
...
<%--                     <button id="btn<%=i%>" cid=<jsp:getProperty name="com" property="commodity_id" /> 
                     class="btn-danger pull-left col-sm-2 btn-sm sendmessage">删除</button> --%>
                     <a class="btn-primary col-sm-3 btn-sm" href="user/payforcart">结算</a>
                  </div>
				</td>
