  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="<%=request.getContextPath()%>/user/cardinfopage"><i class="fa fa-clone"></i> <span>会员卡信息</span></a></li>
...
<jsp:useBean id="clist" class="java.util.ArrayList" scope="page"></jsp:useBean>
<jsp:useBean id="score" class="beans.Commodity_view" scope="page"></jsp:useBean>
<jsp:useBean id="slist" class="beans.StoreList" scope="page"></jsp:useBean>
<jsp:useBean id="store" class="model.Store" scope="page"></jsp:useBean>



<% clist = (ArrayList<Commodity_view>)session.getAttribute("colist");
slist = (StoreList)session.getAttribute("stlist");%>
 ...
 <form class="form-horizontal" action="user/commoditylist">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    ...
                    <select class="form-control col-sm-2" name="sid">
                    <% for(int i=0;i<slist.getList().size();i++){
                    	store = slist.getList(i);
                    
                    	
                    	if((session.getAttribute("store_id").toString()).equals(store.getId()+"")){%>
                    	
                    	<option selected><%=store.getId() %>-<%=store.getName() %></option>
                    ...
                    %>
                    <option><%=store.getId() %>-<%=store.getName() %></option>
					...
					<label for="exampleInputEmail1" class="pull-right"><h4  style="margin-top:3">日期</h4></label>
                     ...
                     <div class="col-sm-2">
                    	<input  type="date" class="form-control col-sm-2"  name="time" value="2016-03-21">
                    
                    </div>
                    
          

                    <button type="submit" class="btn btn-info pull-left col-sm-1">显示商品</button>
