...
<li class="treeview">
        ...
        <li class=""><a href="<%=request.getContextPath()%>/staff/planlist"><i class="fa fa-toggle-right"></i><span>查看计划</span></a></li>
        <li class="treeview">
         ...
         <li class="active"><a href="<%=request.getContextPath()%>/staff/sinfo2"><i class="fa fa-user-md"></i> <span>注册信息</span></a></li>
        </ul> 
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
