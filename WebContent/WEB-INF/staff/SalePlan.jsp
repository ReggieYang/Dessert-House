...
<li class="treeview  active">
        ...
        <li class="active"><a href="<%=request.getContextPath()%>/staff/planlist"><i class="fa fa-toggle-right"></i><span>查看计划</span></a></li>
        <li class="treeview">
    ...
    <TABLE class="table table-striped table-bordered" style='font-family:Microsoft Yahei'>
      <TBODY>
        <TR>
          ...
          <TH width="10%" style="text-align:center">计划状态</TH>
        ...
        <TR>
          ...
          <%if(score.getPlan_status()==0){%>
       		...
       		<span class="label label-danger">未审批</span> 
